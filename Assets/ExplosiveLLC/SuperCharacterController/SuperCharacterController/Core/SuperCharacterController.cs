...
public class SuperCharacterController:MonoBehaviour
{
	...
	private void SingleUpdate()
	{
		...
		if (clampedTo != null && clampToMovingGround && isClamping && clampedTo != null && clampedTo.position - lastGroundPosition != Vector3.zero) {
		...
		if (isClamping && clampedTo != null) { lastGroundPosition = clampedTo.position; }
